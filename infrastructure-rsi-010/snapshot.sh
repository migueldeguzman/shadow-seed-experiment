#!/bin/bash
# RSI-010 Snapshot — Backup all subject workspaces from Docker volumes
# Author: Mia 🌸 | Date: 2026-03-01

LABEL="${1:-snapshot}"
TIMESTAMP=$(date +%Y%m%dT%H%M%S)
BACKUP_DIR="/Users/miguelitodeguzman/ailab/lab-protocol/experiments/rsi-010/data/backups/${LABEL}-${TIMESTAMP}"
HOST_DIR="/Users/miguelitodeguzman/ailab/lab-protocol/experiments/rsi-010/subjects"

mkdir -p "$BACKUP_DIR"

echo "=== RSI-010 Snapshot: $LABEL ==="
