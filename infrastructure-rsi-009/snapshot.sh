#!/bin/bash
# =============================================================
# RSI-008 Snapshot — Backup all subject workspaces
...
BACKUP_DIR="/Users/miguelitodeguzman/ailab/lab-protocol/experiments/rsi-009/data/backups/${LABEL}-${TIMESTAMP}"

mkdir -p "$BACKUP_DIR"

echo "=== RSI-008 Snapshot: $LABEL ==="
